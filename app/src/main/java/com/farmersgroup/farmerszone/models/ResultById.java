...
public class ResultById implements Serializable {
     ...
     * @param othname
     */
    public ResultById(String tfvname, String botname, String othname, String imageurl, String description, String uses, String propagation, String soil, String climate, String health) {
        super();
